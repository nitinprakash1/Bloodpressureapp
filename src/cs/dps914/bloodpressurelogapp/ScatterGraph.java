...
public class ScatterGraph extends Activity{
	...
	public Intent getIntent(Context context){
		...
		mRenderer.setPanLimits(new double[] { 0, 50, 0, 150 });
		//mRenderer.setZoomLimits(new double[] { -10, 20, -10, 40 });
		mRenderer.setZoomRate(1.05f);
		mRenderer.setBackgroundColor(Color.BLACK);
		mRenderer.addXTextLabel(1, "Day");
		mRenderer.addYTextLabel(120, "Systolic");
		
		//mRenderer.setYTitle("Systolic", 1);
